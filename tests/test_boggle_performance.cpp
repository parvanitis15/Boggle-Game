...
TEST_F(BogglePerformanceTest, SmallBoardBasicList) {
    measurePerformance("Small Board (4x4)", createBoggleBoard<4, 4>(), 
...
TEST_F(BogglePerformanceTest, MediumBoardBasicList) {
    measurePerformance("Medium Board (8x8)", createBoggleBoard<8, 8>(), 
                      "Basic Word List", WORD_LIST);
}
...
TEST_F(BogglePerformanceTest, LargeBoardBasicList) {
    measurePerformance("Large Board (16x16)", createBoggleBoard<16, 16>(), 
                      "Basic Word List", WORD_LIST);
}
...
TEST_F(BogglePerformanceTest, HugeBoardBasicList) {
    measurePerformance("Huge Board (32x32)", createBoggleBoard<32, 32>(), 
                      "Basic Word List", WORD_LIST);
}
