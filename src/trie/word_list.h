...
constexpr std::array<std::string_view, 101> WORD_LIST
    = {"THE",   "AND",  "THAT",  "HAVE",  "FOR",   "NOT",   "WITH",   "YOU",   "THIS",  "BUT",
       ...
       "THESE", "GIVE", "DAY",   "MOST",  "PLAY",  "GAME",  "TEAM",   "WORD",  "TEST",  "FIND",
       "MANY",  "MUST", "STILL", "LIFE",  "KNOW",  "SAME",  "TAKE",   "PART",  "REAL",  "CARE",
       "MOVE",  "FACT", "BOOK",  "STAR",  "HAND",  "HERE",  "KIND",   "NEED",  "HOME",  "GROW",
       "FOOD"};
...
constexpr std::array<std::string_view, 1000> EXTENDED_WORD_LIST
    = {"THE",   "AND",  "THAT",  "HAVE",  "FOR",   "NOT",   "WITH",   "YOU",   "THIS",  "BUT",
       ...
       "MANY",  "MUST", "STILL", "LIFE",  "KNOW",  "SAME",  "TAKE",   "PART",  "REAL",  "CARE",
       "MOVE",  "FACT", "BOOK",  "STAR",  "HAND",  "HERE",  "KIND",   "NEED",  "HOME",  "GROW",
       "FOOD",  "ABLE", "ACID",  "AGED",  "ALSO",  "AREA",  "ARMY",   "AWAY",  "BABY",  "BACK",
       "BALL",  "BAND", "BANK",  "BASE",  "BATH",  "BEAR",  "BEAT",   "BEEN",  "BEER",  "BELL",
       ...
       "UPON",  "USED", "USER",  "VARY",  "VAST",  "VERY",  "VICE",   "VIEW",  "VINE",  "VOTE",
